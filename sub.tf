...
resource "google_compute_instance" "instance-testbed-windows" {
  boot_disk {
    auto_delete = true
    device_name = "instance-testbed-windows"
...
resource "google_compute_instance" "instance-webserv-one" {
  boot_disk {
    auto_delete = true
    device_name = "instance-webserv-one"
...
resource "google_compute_instance" "instance-elastic" {
  boot_disk {
    auto_delete = true
    device_name = "instance-elastic"
  ...
  network_interface {
    ...
    queue_count = 0
    stack_type  = "IPV4_ONLY"
    subnetwork  = "projects/certain-gearbox-277406/regions/us-central1/subnetworks/default"
  }
